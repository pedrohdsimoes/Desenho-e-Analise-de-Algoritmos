...
class Graph {
    ...
    Arrays.sort(custos);
    FastPrint.out.print(custos[0]);
    for(int i=1; i<c; i++) FastPrint.out.print(" "+custos[i]);
...
public class Fibra {
    ...
    int possibleC = in.nextInt();
    
    Graph g = new Graph(now+future);
    g.custos = new int[future];
